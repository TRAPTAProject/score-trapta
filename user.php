		...
		<ul class="nav  nav-pills">
			<?php
				if ($displayType==0)
					...
					echo '<li class="nav-item"><a class="nav-link" href="?username='.$username.'&displayType=0">Positions</a></li>';
				if ($displayType==1)
					echo '<li class="nav-item"><a class="nav-link active" href="#">Tir individuels</a></li>';
				else
					echo '<li class="nav-item"><a class="nav-link" href="?username='.$username.'&displayType=1">Tir individuels</a></li>';
				if ($displayType==3)
					echo '<li class="nav-item"><a class="nav-link active" href="#">Par &eacute;quipes</a></li>';
				else
					echo '<li class="nav-item"><a class="nav-link" href="?username='.$username.'&displayType=3">Par &eacute;quipes</a></li>';
				if ($displayType==2)
					echo '<li class="nav-item"><a class="nav-link active" href="#">Matches</a></li>';
				else 
					echo '<li class="nav-item"><a class="nav-link" href="?username='.$username.'&displayType=2">Matches</a></li>';
			?>
